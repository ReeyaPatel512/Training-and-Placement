...
<title>Training And Placement</title>
  ...
  <link href="css/style-responsive.css" rel="stylesheet">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	         <ul class="navbar-nav mr-auto">
	        	<li class="nav-item active"><a href="com_dashboard.php" class="nav-link">Dashboard</a></li>
    ...
    <div class="col-md" style="margin-left: 20px; margin-right: 20px;">
	  ...
	  <h5>Pending Applications<input id="gfg" type="text" placeholder="Search here" style="margin-left:1100px"></h5>
        <table class="table table-striped table-advance table-hover">
		  ...
		  $query= "select * from job as j
				   ...
				   (j.com_id='".$_SESSION['com_id']."' and jobstatus='pending')";
...
<td>
<a href="com_changeapp_status.php?job_id=<?php echo $row['job_id']?>"><button class="btn btn-success btn-xs" name="approve"><i class="fa fa-check"></i></button></a>
               
<a href="com_cha_sta.php?job_id=<?php echo $row['job_id']?>"><button class="btn btn-danger btn-xs" name="reject"><i class="fa fa-trash-o"></i></button></a>
</td>
            </tr>
