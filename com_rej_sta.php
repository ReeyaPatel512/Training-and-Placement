  ...
  <link href="css/style-responsive.css" rel="stylesheet">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	         <ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a href="approve_status.php" class="nav-link">Approved Applications</a></li>
				<li class="nav-item active"><a href="com_rej_sta.php" class="nav-link">Rejected Applications</a></li>
    ...
    <div class="col-md" style="margin-left: 20px; margin-right: 20px;">
      <div class="content-panel">
		 	...
		 	<h4>  <input id="gfg" type="text" placeholder="Search here" style="margin-left:1100px"></h4>
        <table class="table table-striped table-advance table-hover">
		  ...
		  $query= "select * from job as j
				   ...
				   (j.com_id='".$_SESSION['com_id']."' and jobstatus='reject')";
